# GitHub Issues for Jammy - Iteration 1

## Issue #1: Implement PIN Authentication System

**Labels:** `feature`, `auth`, `iteration-1`, `priority-high`
...
## Issue #2: Build Songs CRUD API Endpoints

**Labels:** `feature`, `api`, `iteration-1`, `priority-high`
...
## Issue #3: Create Jam List Dashboard UI

**Labels:** `feature`, `ui`, `iteration-1`, `priority-high`
...
## Issue #4: Build Add Song Page with Manual Entry Form

**Labels:** `feature`, `ui`, `iteration-1`, `priority-medium`
...
## Issue #5: Create Base UI Component Library
...
## Issue #6: Setup Database Migration to PostgreSQL

**Labels:** `infrastructure`, `database`, `iteration-2`, `priority-medium`
...
These issues should be tackled in this order:

1. **Issue #5** - Base UI Component Library (needed by others)
2. **Issue #1** - PIN Authentication System
3. **Issue #2** - Songs CRUD API Endpoints
4. **Issue #3** - Jam List Dashboard UI
5. **Issue #4** - Add Song Page
6. **Issue #6** - Database Migration (after Iteration 1 is complete)

---

## Additional Notes

- All work should be committed to feature branches and merged via PRs
- Each issue should include tests where applicable
- Follow the rock/metal aesthetic defined in ARCHITECTURE.md
